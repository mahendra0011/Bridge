...
import {
  Settings, Bell, Globe, Lock, User, Mail, Eye, EyeOff,
  Moon, Sun, Save, X, Check, Shield, Palette, CreditCard,
...
export default function AgencySettings() {
  ...
  useEffect(() => {
    api.get('/api/agency/settings').then(data => {
  ...
  const handleSave = async () => {
    setSaving(true)
    try {
      await api.put('/api/agency/settings', settings)

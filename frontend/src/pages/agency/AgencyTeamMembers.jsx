...
import { ArrowLeft, Users, UserPlus, Trash2, Crown, User as UserIcon, X, Check } from 'lucide-react'
    ...
    <DashboardLayout>
      <div className="mx-auto max-w-4xl space-y-6 px-4 py-8 sm:px-6 sm:py-10">
        <div className="flex items-center justify-between">
          <div>
            <Link to="/agency/dashboard" className="inline-flex items-center gap-1.5 text-sm font-semibold text-slate-600 hover:text-primary">
              <ArrowLeft className="size-4" /> Dashboard
            </Link>
            <h1 className="mt-2 text-2xl font-extrabold tracking-tight">Agency Team</h1>
            ...
            <div className="w-full max-w-md rounded-2xl bg-white p-6 shadow-xl" onClick={(e) => e.stopPropagation()}>
              ...
              <div className="mt-4 space-y-4">
                <div>
                  ...
                  <input value={inviteEmail} onChange={(e) => setInviteEmail(e.target.value)} type="email" placeholder="teammate@example.com" className="w-full rounded-lg border border-slate-200 px-3 py-2.5 text-sm outline-none focus:border-primary" />
                </div>
                <div>

...
import {
  ...
  Ban, Rocket, FileText, Briefcase, GraduationCap
} from 'lucide-react'
      ...
      <div className="mx-auto max-w-7xl space-y-6 px-4 py-8 sm:px-6 sm:py-10">
        <div className="flex items-start justify-between flex-wrap gap-4">
          <div>
            ...
            <p className="mt-1 text-sm text-slate-500">Manage all your job and internship postings.</p>
          </div>
        ...
        <div className="flex flex-wrap items-center gap-3">
          <div className="relative flex-1 min-w-48">
            ...
            <input value={search} onChange={e => setSearch(e.target.value)} placeholder="Search listings..." className="w-full rounded-lg border border-slate-200 pl-9 pr-3 py-2.5 text-sm outline-none focus:border-primary" />
          </div>
        ...
        {loading ? (
          ...
          <div className="rounded-2xl border border-dashed border-slate-200 p-16 text-center text-slate-400">
            ...
            <p className="mt-1 text-sm">Try a different filter or create a new posting.</p>
          </div>
        ) : (
